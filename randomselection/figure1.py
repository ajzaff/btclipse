...
colors = ('red', 'orange', 'yellow', 'lightGreen', 'black', 'green', 'blue', 'indigo', 'violet')
...
for i, line in enumerate(lines):
    plt.plot(omega_sample, line, color=colors[i], linewidth=2., label=u'p=%s' % (u'%.3f' % rho_sample[i]).rstrip(u'0').rstrip(u'.'))
